...
6. For a big or wide change, run it as an `arena`. Ask several independent runners the same question and merge the answers. Runners with fresh contexts and different lenses catch different real bugs.
