...
Use your configured architect runners from `~/.claude/aileron-models.md` (defaults `fable`, `opus`, `sonnet`). A value of `inherit` means omit `model`.
